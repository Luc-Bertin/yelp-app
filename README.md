...
# OUI : LOGIQUE : le nom peut être le même (exemple MacDonald's) voici les commandes qui le montrent
...
# on voit bien qu'il est impossible d'obtenir un restaurant basé sur uniquement son nom et son lieu
# car la commande suivante groupe par lieux/noms
...
############################ POUR TOUT CE QUI TOUCHE LA COLLECTION USERS ############################
